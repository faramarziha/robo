...
if (!empty($authority) && !empty($PaySetting)) {
    ...
    if ($isExpired) {
        ...
        if ($Payment_report['payment_Status'] != "paid") {
            ...
            if ($pricecashback != "0" && !empty($Balance_id)) {
                ...
                $Balance_confirm = intval($Balance_id['Balance']) + $resultCashback;
                update("user", "Balance", $Balance_confirm, "id", $Balance_id['id']);
