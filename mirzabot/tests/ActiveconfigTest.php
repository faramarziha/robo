...
class ActiveconfigTest extends TestCase {
    
    public function testActiveconfigBatchQuery() {
        global $pdo;
        ...
        $pdo->expects($this->any())
            ...
            ->willReturnCallback(function($query) use ($userSelectStmt, $invoiceSelectStmt, $invoiceUpdateStmt) {
                if (strpos($query, "SELECT id FROM user WHERE checkstatus = '1'") !== false) {
        ...
        require __DIR__ . '/../cronbot/activeconfig.php';
    }
}
