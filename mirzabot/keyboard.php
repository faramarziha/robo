...
$PaySettingtetrapay = getPaySettingValue("statustetrapay");
if ($PaySettingtetrapay == "ontetrapay") {
    $step_payment['inline_keyboard'][] = [
        ['text' => "🌐 درگاه تتراپی (TetraPay)", 'callback_data' => "tetrapay"]
    ];
}
$PaySettingstars = getPaySettingValue("statusstars");
if ($PaySettingstars == "onstars") {
    $step_payment['inline_keyboard'][] = [
        ['text' => "⭐️ پرداخت با استارز تلگرام (Telegram Stars)", 'callback_data' => "telegram_stars"]
    ];
}
...
$Startelegram = json_encode([
    'keyboard' => [
        [['text' => $textbotlang['keyboard']['starsRateMode']], ['text' => $textbotlang['keyboard']['starsManualRate']]],
        [['text' => $textbotlang['keyboard']['starsMargin']], ['text' => $textbotlang['keyboard']['starsMaxCountBtn']]],
        ...
        [['text' => $textbotlang['keyboard']['starsExpiry']]],
        [['text' => $textbotlang['Admin']['backAdminBtn']], ['text' => $textbotlang['Admin']['backMenuBtn']]]
    ],
    'resize_keyboard' => true
]);
$TetraPaySetting = json_encode([
    'keyboard' => [
        [['text' => $textbotlang['keyboard']['tetraMerchant']], ['text' => $textbotlang['keyboard']['tetraCashback']]],
        [['text' => $textbotlang['keyboard']['tetraMinAmount']], ['text' => $textbotlang['keyboard']['tetraMaxAmount']]],
        [['text' => $textbotlang['keyboard']['tetraExpiry']]],
        [['text' => $textbotlang['Admin']['backAdminBtn']], ['text' => $textbotlang['Admin']['backMenuBtn']]]
    ],
    'resize_keyboard' => true
]);
