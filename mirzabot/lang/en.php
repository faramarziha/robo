...
',
                        ...
                        'starsMaxCount' => '❌ This order equals {stars} Stars, which is above the allowed limit ({max} Stars). Please choose a smaller amount or use another payment method.',
...
If you want the user to purchase unlimited, send the number 0',
                        ...
                        'askStarsRateMode' => '🔄 Choose how the Star rate is calculated:

<b>usdt</b> = live USDT rate from Nobitex
<b>ton</b> = live TON rate from Nobitex
<b>off</b> = manual rate

Send usdt, ton or off.',
                        'starsRateModeSaved' => '✅ Stars rate mode saved.',
                        'starsRateModeInvalid' => '❌ Only usdt, ton or off are allowed.',
                        'askStarsManualRate' => '✏️ Send the price of 1 Star in Toman (used only when rate mode is off).',
                        'askStarsMargin' => '📈 Send the margin percent. Telegram takes a commission on Stars, so 20-30 is suggested.',
                        'askStarsExpiry' => '⏱ Send the invoice validity in minutes (suggested: 30).',
                        'askStarsMaxCount' => '⭐ Send the maximum Stars per invoice (0 = unlimited).',
                        'askTetraMerchant' => '🔑 Send your TetraPay API key.',
                        'settingSaved' => '✅ Setting saved.',
                        'starsRateNow' => '⭐ Live rate per Star: <b>{rate}</b> Toman',
...
- Service username :‌ {service_username}',
                ...
                'starsRateMode' => '🔄 Stars rate mode',
                'starsManualRate' => '✏️ Manual rate per Star',
                'starsMargin' => '📈 Stars margin %',
                'starsExpiry' => '⏱ Stars invoice expiry',
                'starsMaxCountBtn' => '⭐ Max Stars per invoice',
                'tetraMerchant' => '🔑 TetraPay API key',
                'tetraCashback' => '💰 TetraPay cashback',
                'tetraMinAmount' => '⬇️ TetraPay min amount',
                'tetraMaxAmount' => '⬆️ TetraPay max amount',
                'tetraExpiry' => '⏱ TetraPay invoice expiry',
